...
import io.healthe.util.IntentIntegrator;
import io.healthe.util.IntentResult;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (intentResult != null) {
            ...
            if (contents != null && !TextUtils.isEmpty(contents)){
                ...
                intent.putExtra(ProductInfoActivity.EXTRA_CONTENT,contents);
                startActivity(intent);
            }else {
                Snackbar.make(drawer, "Scan returned no results", Snackbar.LENGTH_LONG).show();
            }
        }
    }
}
